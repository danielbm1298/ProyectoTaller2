...
#Canvas Principal
PP = Canvas(VP,width=500,height=500,bg = "#000000")
PP.pack()
#Clases
class Calculadora:
...
#Variables que contienen las clases
c = Calculadora()
a = Ahorcado()
#Funciones de botones de la pantalla principal
def VC():
    VP.withdraw()
    VC = Toplevel()
    VC.title("Calculadora")
    VC.minsize(500,500)
    VC.resizable(width=NO,height=NO)
    CP = Canvas(VC,width=500,height=500,bg="#000000")
    CP.pack()
#Botones Calculadora
...
BCalc = Button(PP,text = "Calculadora", command = VC)
BCalc.place(x=100,y=100)

BAh = Button(PP, text = "Ahorcado el Ganso", command = )
BAh.place(x=200,y=200)
